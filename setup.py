...
if __name__ == "__main__":
    ...
    setup(
        name="store-products",
        version="1.0.0",
        description="This repository represents the logic of the products.",
        author="Samuel Duncan",
        author_email="srduncanv1217@gmail.com",
        url="https://github.com/sduncanv/store-products.git",
        packages=[
            'Products.Classes', 'Products.Models'
        ],
        package_dir={
            'Products.Classes': 'Classes', 'Products.Models': 'Models'
        },
